...
完整职责定义在 `agents/position-advisor.md`，先读那份文件。
只读 workspace/runs/{run_id}/dataset.json、workspace/runs/{run_id}/market.json、workspace/runs/{run_id}/sectors.json、config/positions.yaml；只写 workspace/runs/{run_id}/positions_review.json；
