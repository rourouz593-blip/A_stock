...
**完整职责定义在 `agents/market-analyst.md`，先读那份文件再动手。**

- 只读：workspace/runs/{run_id}/dataset.json
- 只写：workspace/runs/{run_id}/market.json
- 结构：`schemas/market.schema.json`
- 技能：`skills/market-emotion-cycle/SKILL.md`、`skills/intraday-rhythm/SKILL.md`、`skills/a-share-market-basics/SKILL.md`
