...
用法（从仓库根目录执行）:
    python -m agents.data_engineer.scripts.build_dataset --run-id 2026-08-28_close --as-of 2026-08-28
    python -m agents.data_engineer.scripts.build_dataset --run-id ... --as-of ... --no-cache
...
from agents.data_engineer.scripts import ak_client  # noqa: E402
from agents.data_engineer.scripts.clean import derive  # noqa: E402
from agents.data_engineer.scripts.fetch import breadth as f_breadth  # noqa: E402
from agents.data_engineer.scripts.fetch import calendar as f_cal  # noqa: E402
from agents.data_engineer.scripts.fetch import market as f_market  # noqa: E402
from agents.data_engineer.scripts.fetch import news as f_news  # noqa: E402
from agents.data_engineer.scripts.fetch import sectors as f_sectors  # noqa: E402
from agents.data_engineer.scripts.fetch import stocks as f_stocks  # noqa: E402
from core import repository as store  # noqa: E402
from core.contracts import DataBlock, Provenance, QualityFlag  # noqa: E402
...
def build(run_id: str, as_of: str, mode: str = "close", with_positions: bool = True) -> dict:
    ...
    if with_positions:
        try:
            from agents.position_advisor.scripts.positions import load_positions
