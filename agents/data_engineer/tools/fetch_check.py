...
def _probe(name, as_of, days, codes):
    ...
    from agents.data_engineer.scripts.fetch import breadth as f_br
    from agents.data_engineer.scripts.fetch import market as f_mk
    from agents.data_engineer.scripts.fetch import news as f_nw
    from agents.data_engineer.scripts.fetch import sectors as f_sc
    from agents.data_engineer.scripts.fetch import stocks as f_st
...
def main() -> int:
    ...
    from agents.data_engineer.scripts.ak_client import budget_state, cooling_hosts, explain
    from agents.data_engineer.scripts.fetch import calendar as f_cal
