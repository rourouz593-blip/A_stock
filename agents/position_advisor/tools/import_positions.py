...
1. 用户上传券商 App 的持仓截图
2. **有视觉能力的 agent 读图**，按 `agents/position_advisor/skills/positions-import/SKILL.md` 抽出字段
...
def main() -> None:
    ...
    from agents.position_advisor.scripts.history import append_snapshot, behavior_signals  # noqa: E402
